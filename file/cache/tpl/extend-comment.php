...
<img src="<?php echo useravatar($v['uname']);?>" width="48" alt="" align="absmiddle"/><?php if($v['uname']) { ?></a><?php } ?>
</div>
</td>
<td valign="top">
...
<form method="post" action="<?php echo $EXT['guestbook_url'];?>index.php" id="r_form" target="_blank">
