...
<table>
<tr>
<td width="30"><a href="<?php echo $MODULE[$moduleid]['linkurl'];?><?php echo rewrite('search.php?username='.$t['username']);?>" rel="nofollow"><img src="<?php echo useravatar($t['username'], 'small');?>" width="20" alt="<?php echo $t['username'];?>"/></a></td>
...
<td width="110" class="px11" align="center"><?php echo timetodate($t['edittime'], $datetype);?></td>
</tr>
</table>
</div>
<?php } } ?>
