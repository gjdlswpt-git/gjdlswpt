...
<div class="m">
<div class="b10">&nbsp;</div>
<div class="box_head"><div><span class="f_r"><a href="<?php echo $MOD['linkurl'];?><?php echo $CAT['linkurl'];?>">更多&raquo;</a></span><strong>同类<?php echo $MOD['name'];?></strong></div></div>
<div class="box_body">
<div class="thumb" style="padding:10px;"><?php echo tag("moduleid=$moduleid&length=20&condition=status=3 and thumb<>''&catid=$catid&areaid=$cityid&pagesize=8&order=edittime desc&width=80&height=80&cols=8&template=thumb-table", -2);?>
</div>
</div>
</div>
<div class="m">
